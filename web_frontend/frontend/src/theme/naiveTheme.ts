...
export function createThemeOverrides(p: AppPalette): GlobalThemeOverrides {
  return {
    ...
    Message: {
      ...
      colorLoading: p.surface,
      textColor: p.text,
      textColorInfo: p.text,
      textColorSuccess: p.text,
      textColorWarning: p.text,
      textColorError: p.text,
      textColorLoading: p.text,
      iconColor: p.text,
      iconColorInfo: p.text,
      iconColorSuccess: p.text,
      iconColorWarning: p.text,
      iconColorError: p.text,
      iconColorLoading: p.text,
    ...
    Notification: {
      ...
      iconColorWarning: p.text,
      iconColorError: p.text,
      closeIconColor: p.text,
      closeIconColorHover: p.text,
      closeIconColorPressed: p.text,
