...
.back-pill, .primary-pill, .account-pill, .repository-row i, .repository-row b { border-radius: var(--app-radius-pill); }
...
.git-import-state, .github-login-panel, .clone-progress-panel { display: grid; place-content: center; justify-items: center; gap: 12px; min-height: 390px; border: 1px solid var(--app-border); border-radius: var(--app-radius-xl); background: var(--app-surface); color: var(--app-text-muted); text-align: center; }
...
.repository-list { min-height: 0; overflow-y: auto; overscroll-behavior: contain; display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); align-content: start; gap: 10px; padding-right: 4px; }.repository-row { min-height: 82px; display: grid; grid-template-columns: auto minmax(0, 1fr) auto auto; align-items: center; gap: 12px; width: 100%; padding: 14px; border: 1px solid var(--app-border); border-radius: var(--app-radius-lg); background: var(--app-surface); color: var(--app-text); text-align: left; cursor: pointer; transition: border-color 160ms ease, transform 160ms ease; }.repository-row:hover { border-color: var(--app-text); transform: translateY(-1px); }.repository-row img { width: 42px; height: 42px; border-radius: var(--app-radius-md); }.repository-row > span { min-width: 0; display: grid; gap: 4px; }.repository-row strong { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.repository-row small { overflow: hidden; color: var(--app-text-muted); text-overflow: ellipsis; white-space: nowrap; }.repository-row i, .repository-row b { padding: 7px 10px; font-size: 11px; font-style: normal; font-weight: 500; white-space: nowrap; }.repository-row i { border: 1px solid var(--app-border); color: var(--app-text-muted); }.repository-row b { background: var(--app-text); color: var(--app-text-inverse); }
.repository-empty { grid-column: 1 / -1; min-height: 240px; display: grid; place-items: center; color: var(--app-text-muted); }.clone-progress-panel > span { color: var(--app-text-muted); }.clone-progress-track { width: min(480px, 70vw); height: 7px; overflow: hidden; border-radius: var(--app-radius-pill); background: var(--app-surface-muted); }.clone-progress-track i { display: block; height: 100%; border-radius: inherit; background: var(--app-text); transition: width 180ms ease; }.clone-progress-meta { width: min(480px, 70vw); display: flex; justify-content: space-between; color: var(--app-text-muted); font: 11px/1.2 var(--app-font-mono); }
