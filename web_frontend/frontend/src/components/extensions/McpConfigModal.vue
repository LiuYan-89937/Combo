...
.policy-section { margin-top: 8px; padding: 16px; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); }
.section-copy { margin-bottom: 12px; }
.switch-row { display: flex; align-items: center; justify-content: space-between; gap: 20px; }
.install-steps { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); margin-bottom: 20px; overflow: hidden; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); }
...
.install-console { display: grid; gap: 13px; margin-top: 18px; padding: 15px; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); background: var(--app-surface); }.install-console header { display: flex; align-items: center; justify-content: space-between; gap: 16px; }.install-console header > div { display: grid; gap: 2px; }.console-kicker { color: var(--app-text-muted); font-size: 8px; font-weight: 800; letter-spacing: .14em; }.install-console header strong { font-size: 12px; }.install-timeline { display: grid; max-height: 230px; overflow-y: auto; }.install-event { position: relative; display: grid; grid-template-columns: 12px minmax(0, 1fr); gap: 9px; min-height: 42px; }.install-event::before { position: absolute; top: 14px; bottom: 0; left: 4px; width: 1px; content: ''; background: var(--app-border); }.install-event:last-child::before { display: none; }.install-event > i { z-index: 1; width: 9px; height: 9px; margin-top: 3px; border: 2px solid var(--app-surface); border-radius: 50%; background: var(--app-text); }.install-event > div { display: grid; align-content: start; gap: 3px; padding-bottom: 11px; }.install-event strong { font-size: 10px; }.install-event span { color: var(--app-text-muted); font-family: var(--app-font-mono); font-size: 9px; overflow-wrap: anywhere; }.install-error { margin: 0; padding: 10px; color: var(--app-error); border: 1px solid color-mix(in srgb, var(--app-error) 30%, transparent); border-radius: var(--app-radius-sm); font-family: var(--app-font-mono); font-size: 10px; white-space: pre-wrap; }
