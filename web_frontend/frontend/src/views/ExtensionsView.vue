...
.page-alert { max-width: 1540px; margin: 12px auto; }.mcp-probe-notice { display: grid; grid-template-columns: 24px minmax(0, 1fr) 24px; max-width: 1540px; align-items: center; gap: 10px; box-sizing: border-box; margin: 12px auto; padding: 11px 13px; color: var(--app-text-inverse); border: 1px solid var(--app-text); border-radius: var(--app-radius-sm); background: var(--app-text); }.mcp-probe-notice > span { display: grid; width: 19px; height: 19px; place-items: center; color: var(--app-text); border-radius: 50%; background: var(--app-text-inverse); font-size: 10px; }.mcp-probe-notice strong { overflow: hidden; font-size: 11px; text-overflow: ellipsis; white-space: nowrap; }.mcp-probe-notice button { padding: 0; color: var(--app-text-inverse); border: 0; background: transparent; font-size: 20px; line-height: 1; cursor: pointer; }.pool-surface { max-width: 1540px; margin: 0 auto; padding: 24px; border: 1px solid var(--app-border); border-radius: var(--app-radius-lg); background: var(--app-surface); }.pool-heading { display: flex; align-items: flex-end; justify-content: space-between; gap: 24px; padding: 2px 2px 22px; border-bottom: 1px solid var(--app-border); }.pool-heading h2 { margin: 0; font-size: 22px; letter-spacing: -.02em; }
.card-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 12px; padding-top: 18px; }.pool-card { display: flex; min-height: 176px; flex-direction: column; padding: 17px 18px 14px; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); background: var(--app-surface); cursor: pointer; transition: border-color .16s ease, box-shadow .16s ease, transform .16s ease; }.pool-card:hover,.pool-card:focus-visible { transform: translateY(-3px); border-color: var(--app-border-focus); box-shadow: 0 14px 30px color-mix(in srgb, var(--app-text) 7%, transparent); outline: none; }.card-header,.card-footer,.card-statuses,.status,.card-buttons,.skill-editor-header,.skill-editor-header > div,.section-row,.switch-line,.card-title-line { display: flex; align-items: center; }.card-header,.card-footer,.section-row,.switch-line { justify-content: space-between; }.card-statuses { gap: 10px; }.type-pill { display: inline-flex; width: fit-content; padding: 4px 7px; border-radius: var(--app-radius-sm); background: var(--app-text); color: var(--app-text-inverse); font-size: 9px; font-weight: 800; letter-spacing: .08em; }.status { gap: 6px; color: var(--app-text-muted); font-size: 10px; }.status i { width: 6px; height: 6px; border-radius: 50%; background: var(--app-success); }.status.indexed i { background: var(--app-text); box-shadow: none; }.status.muted i { background: var(--app-text-muted); }.card-body { flex: 1; padding: 22px 0 14px; }.card-title-line { min-width: 0; gap: 9px; }.card-tool-icon { display: inline-flex; flex: 0 0 auto; align-items: center; justify-content: center; width: 30px; height: 30px; border: 1px solid var(--app-border); border-radius: var(--app-radius-sm); background: color-mix(in srgb, var(--app-text) 4%, transparent); color: var(--app-text); }.card-body h3 { margin: 0; overflow: hidden; font-size: 16px; letter-spacing: -.01em; text-overflow: ellipsis; white-space: nowrap; }.card-facts { display: flex; min-height: 24px; flex-wrap: wrap; gap: 6px; margin-bottom: 12px; }.card-facts span { padding: 3px 7px; border-radius: var(--app-radius-sm); background: color-mix(in srgb, var(--app-text) 5%, transparent); color: var(--app-text-muted); font-size: 9px; }.card-footer { min-height: 30px; padding-top: 11px; border-top: 1px solid var(--app-border); color: var(--app-text-muted); font-size: 10px; }.card-buttons { gap: 1px; }.empty-state { padding: 90px 0; }
.editor-intro { padding: 2px 0 18px; border-bottom: 1px solid var(--app-border); }.editor-form { display: grid; gap: 14px; padding-top: 18px; }.form-section { padding: 17px; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); }.form-section.two-column { display: grid; grid-template-columns: 1fr 1fr; gap: 0 14px; }.section-title { display: grid; margin-bottom: 15px; }.section-title.full { grid-column: 1 / -1; }.section-title strong,.switch-line strong { font-size: 13px; }.section-row .section-title { margin-bottom: 10px; }
.creator-layout { display: grid; grid-template-columns: minmax(0, 1.08fr) minmax(0, .92fr); align-items: start; gap: 18px; }.creator-form { display: grid; min-width: 0; align-content: start; gap: 14px; }.creator-form .form-section,.source-pane { box-sizing: border-box; min-width: 0; }.parameter-card { margin-top: 10px; padding: 14px; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); background: var(--app-surface-subtle, color-mix(in srgb, var(--app-text) 2%, transparent)); }.parameter-head { display: flex; align-items: center; justify-content: space-between; margin-bottom: 11px; }.parameter-head > span { color: var(--app-text-secondary); font-size: 11px; font-weight: 700; }.parameter-fields { display: grid; grid-template-columns: minmax(0, 1fr) 140px 82px; gap: 0 10px; }.parameter-fields :deep(.n-form-item) { min-width: 0; margin-bottom: 10px; }.parameter-description { grid-column: 1 / -1; }.required-field :deep(.n-form-item-blank) { align-items: center; }.source-pane { padding: 17px; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); }.source-header { align-items: flex-start; gap: 14px; }.source-header .pane-note { min-width: 0; flex: 1; }.source-actions { display: flex; flex: none; flex-wrap: nowrap; justify-content: flex-end; gap: 8px; }.file-button { position: relative; display: inline-flex; min-height: 32px; align-items: center; justify-content: center; box-sizing: border-box; padding: 6px 11px; border: 1px solid var(--app-border); border-radius: var(--app-radius-sm); color: var(--app-text); font-size: 11px; line-height: 1; white-space: nowrap; cursor: pointer; }.file-button:hover { border-color: var(--app-text); }.file-button input { position: absolute; width: 1px; height: 1px; opacity: 0; }.full { grid-column: 1 / -1; }
.creator-progress { margin-top: 16px; }
.transcription-progress { display: grid; gap: 7px; margin: -2px 0 12px; padding: 10px 12px; border: 1px solid var(--app-border); border-radius: var(--app-radius-sm); color: var(--app-text-secondary); background: var(--app-surface-subtle, color-mix(in srgb, var(--app-text) 3%, transparent)); }
...
.transcription-progress-track { height: 3px; overflow: hidden; border-radius: var(--app-radius-pill); background: var(--app-divider); }
...
.resource-upload { display: grid; gap: 10px; margin-top: 16px; padding-top: 15px; border-top: 1px solid var(--app-border); }.resource-file-list { display: flex; flex-wrap: wrap; gap: 7px; }.resource-file-list span { display: inline-flex; align-items: center; gap: 6px; max-width: 100%; padding: 5px 8px; border: 1px solid var(--app-border); border-radius: var(--app-radius-sm); color: var(--app-text-secondary); font-size: 10px; }.resource-file-list button { padding: 0; color: var(--app-text-muted); border: 0; background: transparent; cursor: pointer; font-size: 15px; line-height: 1; }.resource-file-list > button { display: inline-flex; align-items: center; gap: 6px; max-width: 100%; padding: 6px 9px; color: var(--app-text-secondary); border: 1px solid var(--app-border); border-radius: var(--app-radius-sm); background: var(--app-surface); cursor: pointer; font-size: 10px; }.resource-file-list > button.active { color: var(--app-text); border-color: var(--app-text); }.resource-file-list > button small { color: var(--app-text-muted); font-size: 9px; }
...
.skillhub-connection { display: inline-flex; flex: none; align-items: center; gap: 7px; margin-top: 3px; padding: 6px 10px; color: var(--app-text); border: 1px solid var(--app-border); border-radius: var(--app-radius-pill); background: var(--app-surface); font-size: 10px; }
...
.skillhub-search { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 12px; min-height: 58px; padding: 7px 8px 7px 18px; border: 1px solid var(--app-text); border-radius: var(--app-radius-lg); background: var(--app-surface); }
...
.skillhub-search button { min-width: 78px; height: 42px; padding: 0 18px; color: var(--app-text-inverse); border: 1px solid var(--app-text); border-radius: var(--app-radius-md); background: var(--app-text); font-size: 12px; font-weight: 750; cursor: pointer; }
...
.skillhub-results article { display: grid; grid-template-columns: 42px minmax(0, 1fr) auto; align-items: center; gap: 14px; padding: 16px; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); background: var(--app-surface); cursor: pointer; transition: border-color .16s ease, transform .16s ease; }
...
.skillhub-result-mark { width: 42px; height: 42px; border-radius: var(--app-radius-md); font-size: 15px; }
...
.skillhub-empty { display: grid; min-height: 180px; place-content: center; gap: 6px; color: var(--app-text); text-align: center; border: 1px dashed var(--app-border); border-radius: var(--app-radius-md); }
...
.skillhub-preview-mark { width: 52px; height: 52px; border-radius: var(--app-radius-md); font-size: 18px; }
...
.mcp-detail-hero { display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 10px 18px; padding-bottom: 18px; border-bottom: 1px solid var(--app-border); }.mcp-detail-hero > div { display: flex; min-width: 0; align-items: center; gap: 10px; }.mcp-detail-hero h2 { margin: 0; overflow: hidden; font-size: 20px; text-overflow: ellipsis; white-space: nowrap; }.mcp-connection-facts { display: grid; grid-template-columns: 1fr 1fr; gap: 1px; margin-top: 18px; overflow: hidden; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); background: var(--app-border); }.mcp-connection-facts > div { display: grid; gap: 4px; padding: 13px; background: var(--app-surface); }.mcp-connection-facts small { color: var(--app-text-muted); font-size: 9px; }.mcp-connection-facts strong { overflow: hidden; font-size: 11px; text-overflow: ellipsis; white-space: nowrap; }.mcp-detail-tabs { margin-top: 18px; }.mcp-catalog-list { display: grid; gap: 8px; padding-top: 8px; }.mcp-catalog-list article { display: grid; gap: 5px; padding: 13px; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); }.mcp-catalog-list strong { font-size: 12px; }.mcp-catalog-list p { margin: 0; color: var(--app-text-secondary); font-size: 10px; line-height: 1.55; }.mcp-catalog-list code { overflow-wrap: anywhere; color: var(--app-text-muted); font-size: 9px; }
.mcp-log-list { display: grid; gap: 6px; padding-top: 8px; }.mcp-log-list > p { display: grid; grid-template-columns: 62px minmax(0, 1fr); gap: 10px; margin: 0; padding: 9px 11px; border: 1px solid var(--app-border); border-radius: var(--app-radius-sm); }.mcp-log-list span { color: var(--app-text-muted); font-size: 9px; text-transform: uppercase; }.mcp-log-list code { overflow-wrap: anywhere; font-size: 9px; }
.mcp-resource-row { grid-template-columns: minmax(0, 1fr) auto; }.mcp-resource-row > p,.mcp-resource-row > code { grid-column: 1; }.mcp-resource-row > .n-button { grid-column: 2; grid-row: 1 / span 3; align-self: center; }.mcp-resource-preview { margin-top: 12px; padding: 12px; overflow: auto; border: 1px solid var(--app-border); border-radius: var(--app-radius-md); }.mcp-resource-preview img { display: block; max-width: 100%; max-height: 460px; margin: auto; object-fit: contain; }.mcp-resource-preview audio { width: 100%; }.mcp-resource-preview pre { margin: 0; white-space: pre-wrap; overflow-wrap: anywhere; font-size: 11px; }
