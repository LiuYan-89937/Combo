...
.diff-preview-card { width: min(1240px, 100%); height: min(760px, 100%); min-width: 0; min-height: 0; display: grid; grid-template-rows: auto auto minmax(0, 1fr); gap: 12px; padding: 24px; overflow: hidden; border: 1px solid var(--app-border); border-radius: var(--app-radius-xl); background: var(--app-surface-elevated); box-shadow: var(--app-shadow-lg); }
...
.preview-total { display: inline-flex; align-items: center; gap: 8px; padding: 9px 13px; border: 1px solid var(--app-border); border-radius: var(--app-radius-pill); letter-spacing: 0 !important; }.preview-total b { color: var(--app-diff-addition); }.preview-total i { color: var(--app-diff-deletion); font-style: normal; }
.preview-file-row { min-width: 0; display: flex; align-items: center; gap: 12px; }.preview-file-row code { min-width: 0; overflow: hidden; color: var(--app-text-muted); font-size: 11px; text-overflow: ellipsis; white-space: nowrap; }.preview-file-pill { flex: 0 0 auto; padding: 9px 14px; border: 1px solid var(--app-text); border-radius: var(--app-radius-pill); background: var(--app-text); color: var(--app-text-inverse); font: 11px/1 var(--app-font-mono); }
@media (max-width: 700px) { .diff-preview-page { padding: 12px; }.diff-preview-card { padding: 16px; border-radius: var(--app-radius-lg); }.diff-preview-header { align-items: flex-start; flex-direction: column; }.preview-total { align-self: flex-start; } }
</style>
