...
from combo.tooling.builtins.mcp_installer.specs import (
...
def evaluate_risk(arguments: dict[str, Any], context: dict[str, Any]) -> dict[str, Any]:
    return {
        "action": "ask",
        "risk_level": "high",
        "reasons": ["installing MCP servers persists configuration and connects external processes or services"],
    }
