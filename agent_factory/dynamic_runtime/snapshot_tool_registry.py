...
from agent_factory.dynamic_runtime.capability_definitions import ToolRuntimePolicy
...
def _apply_runtime_policy_metadata(item: MaterializedSnapshotTool) -> MaterializedSnapshotTool:
    ...
    agent_factory_metadata = dict(metadata.get("agent_factory") or {})
    policy = item.runtime_policy
    agent_factory_metadata.update(
        {
    ...
    metadata["agent_factory"] = agent_factory_metadata
