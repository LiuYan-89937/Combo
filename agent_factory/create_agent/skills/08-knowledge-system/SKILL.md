...
description: Owns knowledge runtime contract configuration.
metadata:
...
## System Boundary
Owns knowledge runtime contract configuration.

## Stage Order
8. This skill is used only when `active_system.system_id` is `knowledge_system`.
