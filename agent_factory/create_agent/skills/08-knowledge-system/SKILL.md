...
description: Guides knowledge runtime contract configuration.
metadata:
...
## Focus Role
Guides knowledge runtime contract configuration.

## Focus Use
8. Use this skill when it is relevant to the current manufacturing focus.
...
- `examples/knowledge_system.minimal.json`
