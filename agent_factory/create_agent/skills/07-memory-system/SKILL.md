...
description: Guides memory runtime contract configuration.
metadata:
...
## Focus Role
Guides memory runtime contract configuration.

## Focus Use
7. Use this skill when it is relevant to the current manufacturing focus.
