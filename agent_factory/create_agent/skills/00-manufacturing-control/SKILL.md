...
- Capability assembly order is model selection first, SkillHub second, package tool authoring third. Do not write package tools before model_pool_select and SkillHub reuse have been resolved.
