...
description: Owns assembly specification and optional custom patterns.
metadata:
...
## System Boundary
Owns assembly specification and optional custom patterns.

## Stage Order
12. This skill is used only when `active_system.system_id` is `assembly_pattern_system`.
