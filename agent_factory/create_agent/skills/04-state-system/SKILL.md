...
description: Guides state contract and package state files.
metadata:
...
## Focus Role
Guides state contract and package state files.

## Focus Use
4. Use this skill when it is relevant to the current manufacturing focus.
