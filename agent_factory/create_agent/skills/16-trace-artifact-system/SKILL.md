...
description: Guides trace and artifact runtime contracts.
metadata:
...
## Focus Role
Guides trace and artifact runtime contracts.

## Focus Use
16. Use this skill when it is relevant to the current manufacturing focus.
