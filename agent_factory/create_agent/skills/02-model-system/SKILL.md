...
description: Guides model runtime contract configuration.
metadata:
...
## Focus Role
Guides model runtime contract configuration.

## Focus Use
2. Use this skill when it is relevant to the current manufacturing focus.
