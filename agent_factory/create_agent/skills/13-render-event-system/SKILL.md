...
description: Owns render manifest and render contract.
metadata:
...
## System Boundary
Owns render manifest and render contract.

## Stage Order
13. This skill is used only when `active_system.system_id` is `render_event_system`.
