...
description: Owns session and checkpoint runtime contract configuration.
metadata:
...
## System Boundary
Owns session and checkpoint runtime contract configuration.

## Stage Order
3. This skill is used only when `active_system.system_id` is `session_system`.
