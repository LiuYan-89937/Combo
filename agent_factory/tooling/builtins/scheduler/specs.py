...
def get_scheduler_tool_specs() -> list[ToolSpec]:
    return [
        ToolSpec(
            ...
            entrypoint="agent_factory.tooling.builtins.scheduler.tool:run",
            ...
            risk_evaluator=ToolRiskEvaluatorConfig(
                hard="agent_factory.tooling.builtins.scheduler.tool:evaluate_risk",
            ),
            concurrent=False,
        ...
        "oneOf": [
            ...
            },
            {
                ...
                "properties": {
                    ...
                    "strategy": {"type": "string", "enum": ["auto", "react", "plan_and_execute"], "default": "auto", "description": "触发任务使用的执行图策略。"},
