...
_STAGE_CONTEXTS: dict[str, StageOperatingContext] = {
    ...
    "assembly_spec_generation": StageOperatingContext(
        ...
        allowed_outputs=("assembly_spec", "package_materialization_plan", "render_manifest", "runtime_contract 文件清单", "assembly_validation_report", "产物文件路径"),
    ...
    "package_generation": StageOperatingContext(
        ...
        allowed_outputs=("agent_package.json", "render_manifest.json", "contracts/*.json", "真实工具代码草稿", "package_report", "bindings/prompts/policies/retrieval/formatters 文件"),
