...
from agent_factory.runtime_kernel.fixed_runner import make_fixed_runner
...
def _plan_and_execute_topology() -> FixedTopology:
    return FixedTopology(
        ...
        nodes=(
            ...
            FixedNode("tool_exec", "operational.tool_call"),
            FixedNode("final_answer", "cognitive.answer"),
            FixedNode("commit", "terminal.commit"),
            FixedNode("finalize", "finalize"),
        ),
        edges=(
            ...
            FixedEdge("executor", "final_answer", "model.ready_to_answer"),
            FixedEdge("tool_exec", "planner", "tool.return.planner"),
            FixedEdge("tool_exec", "executor", "tool.return.executor"),
            FixedEdge("tool_exec", "final_answer", "tool.return.final_answer"),
            FixedEdge("tool_exec", "finalize", "tool.interrupted"),
            FixedEdge("tool_exec", "finalize", "policy.blocked"),
            FixedEdge("final_answer", "tool_exec", "model.requests_tool"),
            FixedEdge("final_answer", "planner", "runtime.steered"),
            FixedEdge("final_answer", "commit", "model.ready_to_answer"),
