...
class ResourcePreparationGraphState(FactoryPackageState, total=False):
...
def run_resource_and_condition_planning_subgraph(state: FactoryPackageState) -> dict[str, Any]:
...
def _resource_paths(state: ResourcePreparationGraphState | FactoryPackageState) -> dict[str, str]:
