        ...
        try:
            model_plan = call_structured_model(
                ...
                values={
                    ...
                    "output_json_schema": output_json_schema(PackageBuildPlan),
                },
            )
        except FactoryModelCallError:
            model_plan = None

        plan = merge_package_build_plan(base=base_plan, model_plan=model_plan)
