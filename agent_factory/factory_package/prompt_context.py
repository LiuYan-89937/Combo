...
- 当前已落地 Product Brief、Runtime Design、Capability Contract、Scheduler Preparation 与 Package Build 制造域。
"""
...
def prompt_context_values(_node_id: str) -> dict[str, str]:
    return {
        ...
        "manufacturing_status_context": "当前执行 Product Brief、Runtime Design、Capability Contract、Scheduler Preparation、Package Build，并在 AgentPackage 静态物化后结束，便于测试和精修。",
    }
