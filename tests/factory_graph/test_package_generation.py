...
def _materialization_plan() -> dict:
    return PackageMaterializationPlan(
        ...
        files=[
            ...
            {"path": "contracts/knowledge.json", "file_type": "json", "source_kind": "contract", "source_id": "knowledge", "generation_mode": "system_generated", "contract_source": "runtime_contract:knowledge", "required": True},
            ...
            {"path": "contracts/trace.json", "file_type": "json", "source_kind": "contract", "source_id": "trace", "generation_mode": "system_generated", "contract_source": "runtime_contract:trace", "required": True},
...
def _contracts() -> dict:
    return {
        ...
        "knowledge": {"type": "knowledge", "version": "knowledge_contract.v0", "enabled": True, "config": {}},
