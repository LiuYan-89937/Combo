...
本目录包含赛道二要求的项目说明及配套文档。英文是官方提交默认语言，每份项目自有文档均提供可直接切换的简体中文版本。

| 提交要求 | 文档 |
| --- | --- |
| 完整项目说明 | [项目总览](ProjectOverview.zh-CN.md) |
| 应用场景 | [应用场景](ApplicationScenarios.zh-CN.md) |
| Agent 架构图 | [Agent 架构](AgentArchitecture.zh-CN.md) |
