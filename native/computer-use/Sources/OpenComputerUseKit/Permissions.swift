...
public enum PermissionSupport {
    public static let bundleDisplayName = Bundle.main.object(forInfoDictionaryKey: "CFBundleDisplayName") as? String ?? "Open Computer Use"
    public static let bundleIdentifier = Bundle.main.bundleIdentifier ?? "com.ifuryst.opencomputeruse"
