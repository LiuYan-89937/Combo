  ...
  downloads: [
    {
      ...
      label: 'macOS',
      arch: 'Apple Silicon',
      url: 'https://github.com/LiuYan-89937/Combo/releases/download/v0.1.0/Combo_0.1.0_aarch64.dmg',
      version: '0.1.0',
      sizeLabel: '296 MB',
      downloadCount: 0,
    },
    {
      ...
      label: 'Windows',
      arch: 'x64',
      url: 'https://github.com/LiuYan-89937/Combo/releases/download/v0.1.0/Combo_0.1.0_x64-setup.exe',
      version: '0.1.0',
      sizeLabel: '96.2 MB',
      downloadCount: 0,
    },
