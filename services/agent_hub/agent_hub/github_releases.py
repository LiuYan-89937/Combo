...
LOGGER = logging.getLogger("agent_hub.github_releases")
...
class GitHubReleaseClient:
    def __init__(self, settings: Settings) -> None:
        ...
        headers = {
            ...
            "User-Agent": "FastAgentHub-release-worker",
        ...
        *,
        ...
        try:
            for staged in staged_assets:
                ...
                backup_name = f"{staged.final_name}.fastagenthub-backup-{staged.asset_id}"
...
def _management_marker(management_id: str) -> str:
    return f"<!-- fastagenthub-app-release:{management_id} -->"
