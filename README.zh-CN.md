...
仓库内置三个美股专业 Agent，用于展示真实数据工具、多 Agent 协作和交付：

| Agent | 负责内容 | 典型交付 |
| --- | --- | --- |
| 美股盘面雷达 | 主要指数、涨跌榜和活跃个股 | 盘面简报、异常说明、Markdown 报告、经授权发送的邮件 |
| 美股上市公司研究员 | Yahoo Finance 行情、SEC 公司事实、趋势和用户材料 | 带来源与数据时间的公司研究报告 |
| 美股持仓风险管家 | 集中度、波动率、回撤、标普 500 Beta、相关性和压力情景 | 组合风险报告与情景分析 |
